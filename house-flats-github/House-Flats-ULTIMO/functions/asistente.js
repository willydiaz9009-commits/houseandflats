...
const HF_CEREBRO = {
  ...
  /* zonasAmenidades: qué hay cerca por BARRIO (escuela, universidad, bus, metro,
     dónde comer, supermercado). Referencias REALES pero GENERALES — sin
     direcciones exactas ni negocios concretos. Sophi las usa para responder
     "¿hay metro/escuela/super cerca de X?" de un barrio o del barrio de un match.
     Bilingüe es/en en una línea. */
  zonasAmenidades: [
    'Palermo / Palermo Soho (Buenos Aires) — Escuela: colegios de barrio cerca. Universidad: UADE/UP y coworkings. Bus: muchos colectivos. Metro: Subte D y B a pocos minutos. Comer: cafés de especialidad, bares y restaurantes. Súper: supermercados y tiendas hasta tarde.',
    'Retiro (Buenos Aires) — Escuela: colegios del centro. Universidad: sedes céntricas y coworkings. Bus: gran nudo de colectivos. Metro: Subte y terminal de trenes de Retiro. Comer: cafés y restaurantes variados. Súper: supermercados a mano.',
    'Recoleta (Buenos Aires) — Escuela: colegios tradicionales. Universidad: UBA (Derecho/Económicas). Bus: bien servido. Metro: Subte H y D cerca. Comer: cafés clásicos y restaurantes. Súper: supermercados y gourmet.',
    'San Telmo (Buenos Aires) — Escuela: escuelas de barrio. Universidad: cerca del centro y la UBA. Bus: varias líneas. Metro: Subte C y E. Comer: bares, parrillas y cafés. Súper: Mercado de San Telmo y supermercados.',
    'Belgrano (Buenos Aires) — Escuela: buenos colegios. Universidad: Universidad de Belgrano. Bus: colectivos y tren Mitre. Metro: Subte D. Comer: Barrio Chino, cafés y bares. Súper: supermercados bien surtidos.',
    'Malasaña (Madrid) — Escuela: colegios a minutos. Universidad: UCM y academias; coworkings. Bus: líneas EMT cerca. Metro: Tribunal y Bilbao a minutos. Comer: tapas, cafés de moda y restaurantes. Súper: supermercados y tiendas.',
    'Chamberí (Madrid) — Escuela: buenos colegios. Universidad: Antonio de Nebrija; oficinas. Bus: EMT. Metro: Iglesia/Bilbao/Quevedo. Comer: mercados y restaurantes de barrio. Súper: supermercados y mercado de Vallehermoso.',
    'Lavapiés (Madrid) — Escuela: escuelas céntricas. Universidad: UNED; conectado a Atocha. Bus: EMT cerca. Metro: Lavapiés/Embajadores. Comer: comida internacional asequible y cafés. Súper: supermercados y tiendas del mundo.',
    'La Latina (Madrid) — Escuela: colegios del centro. Universidad: centro y coworkings. Bus: EMT. Metro: La Latina/Tirso de Molina. Comer: tapas en Cava Baja. Súper: supermercados y mercado de la Cebada.',
    'Salamanca (Madrid) — Escuela: colegios bien valorados. Universidad: escuelas de negocio; oficinas. Bus: EMT. Metro: Serrano/Velázquez/Goya. Comer: restaurantes y cafés de diseño. Súper: supermercados y gourmet.',
    'Providencia (Santiago) — Escuela: colegios cerca. Universidad: PUC y coworkings. Bus: micros (Red). Metro: Línea 1 a minutos. Comer: cafés, brunch y restaurantes. Súper: supermercados y galerías.',
    'Las Condes (Santiago) — Escuela: colegios bien valorados. Universidad: UDD y coworkings. Bus: micros frecuentes. Metro: Línea 1 (El Golf, Tobalaba). Comer: restaurantes y malls con patios de comida. Súper: supermercados grandes.',
    'Ñuñoa (Santiago) — Escuela: muchos colegios. Universidad: U. de Chile (Juan Gómez Millas), UMCE. Bus: micros. Metro: Líneas 3 y 6. Comer: bares y restaurantes en Plaza Ñuñoa. Súper: supermercados y ferias.',
    'Bellavista (Santiago) — Escuela: escuelas cercanas. Universidad: U. San Sebastián, PUC. Bus: micros. Metro: Línea 5 (Baquedano), cerca de L1. Comer: bares, patios y restaurantes. Súper: supermercados y almacenes.',
    'Lastarria (Santiago) — Escuela: escuelas céntricas. Universidad: PUC (Casa Central). Bus: micros. Metro: Línea 1 (U. Católica) y L5. Comer: cafés, librerías-café y restaurantes. Súper: supermercados de barrio.',
    'Kreuzberg (Berlín) — Escuela: escuelas y guarderías. Universidad: TU Berlin; coworkings. Bus: bus y tranvía. Metro: U-Bahn U1, U8. Comer: cafés, comida turca e internacional. Súper: supermercados y mercado turco del canal.',
    'Mitte (Berlín) — Escuela: colegios del centro. Universidad: Humboldt-Universität; coworkings. Bus: bus y tranvía. Metro: U-Bahn y S-Bahn (Alexanderplatz, Hbf). Comer: cafés y restaurantes variados. Súper: supermercados cerca.',
    'Prenzlauer Berg (Berlín) — Escuela: muchos colegios. Universidad: conectado al centro; coworkings. Bus: tranvía M10 y buses. Metro: U2 (Eberswalder Str.). Comer: cafés, brunch y restaurantes. Súper: supermercados y mercado de Mauerpark.',
    'Neukölln (Berlín) — Escuela: escuelas de barrio. Universidad: coworkings; campus por U-Bahn. Bus: buena red. Metro: U7, U8. Comer: bares de moda y comida internacional. Súper: supermercados y mercados.',
    'Shoreditch (Londres) — Escuela: colegios del East End. Universidad: "Silicon Roundabout", coworkings; City University. Bus: bus rojo (TfL). Metro: Tube/Overground (Old Street, Shoreditch High St). Comer: street food y restaurantes de moda. Súper: supermercados y Brick Lane.',
    'Camden (Londres) — Escuela: colegios cerca. Universidad: UCL; coworkings de Kings Cross. Bus: bus rojo. Metro: Tube Camden Town (Northern). Comer: Camden Market y comida del mundo. Súper: supermercados y tiendas.',
    'Notting Hill (Londres) — Escuela: buenos colegios. Universidad: Imperial (South Kensington) por Central line. Bus: bus rojo. Metro: Notting Hill Gate (Central/District/Circle). Comer: cafés, pubs y restaurantes. Súper: supermercados y Portobello Market.',
    'Hackney (Londres) — Escuela: escuelas del barrio. Universidad: coworkings en Dalston; cerca de Shoreditch. Bus: bus rojo. Metro: Overground (Hackney Central, Dalston). Comer: cafés independientes y Broadway Market. Súper: supermercados y tiendas locales.',
    'Alfama (Lisboa) — Escuela: escuelas del casco antiguo. Universidad: centro; coworkings junto al río. Bus: buses y tranvía 28. Metro: Santa Apolónia (línea azul). Comer: tascas, fado y cafés. Súper: mini-mercados de barrio.',
    'Baixa (Lisboa) — Escuela: escuelas del centro. Universidad: centros y coworkings. Bus: buses, tranvías y elevadores. Metro: Baixa-Chiado/Rossio. Comer: cafés, pastelerías y restaurantes. Súper: supermercados cerca.',
    'Bairro Alto (Lisboa) — Escuela: escuelas del Chiado. Universidad: bellas artes; coworkings del Chiado. Bus: buses y funicular da Glória. Metro: Baixa-Chiado. Comer: bares y restaurantes; vida nocturna. Súper: mini-mercados de barrio.',
    'Príncipe Real (Lisboa) — Escuela: escuelas cercanas. Universidad: coworkings boutique. Bus: buses cerca; a pie del centro. Metro: Rato (línea amarilla). Comer: cafés de diseño y restaurantes. Súper: supermercados y gourmet.',
    'Trastevere (Roma) — Escuela: escuelas del barrio. Universidad: John Cabot y Sapienza por tranvía. Bus: bus y tranvía 8; estación Trastevere. Metro: algo lejos del metro, bien por tranvía/bus. Comer: trattorias, pizzerías y aperitivo. Súper: supermercados de barrio.',
    'Monti (Roma) — Escuela: escuelas del centro, junto al Coliseo. Universidad: coworkings cercanos. Bus: buses. Metro: Cavour (línea B). Comer: enotecas, trattorias y aperitivo. Súper: supermercados cerca.',
    'San Lorenzo (Roma) — Escuela: escuelas del barrio universitario. Universidad: pegado a La Sapienza. Bus: tranvías 3/19 y buses; junto a Termini. Metro: cerca de Termini (metro y trenes). Comer: bares, pizzerías y comida económica. Súper: supermercados a pasos.',
    'Testaccio (Roma) — Escuela: escuelas residenciales. Universidad: bien conectado; cerca del centro. Bus: buses frecuentes. Metro: Piramide (línea B). Comer: cuna de la cocina romana; trattorias y mercado. Súper: supermercados y mercado de Testaccio.',
    'Le Marais (París) — Escuela: escuelas del centro. Universidad: centro y coworkings. Bus: líneas RATP. Metro: Saint-Paul (L1), Hôtel de Ville. Comer: cafés, falafel y restaurantes de moda. Súper: supermercados de barrio.',
    'Montmartre (París) — Escuela: escuelas del barrio. Universidad: lejos de campus; bien por métro. Bus: buses RATP. Metro: Abbesses (L12), Anvers (L2). Comer: cafés, bistrós y creperías. Súper: supermercados a pasos.',
    'Latin Quarter / Quartier Latin (París) — Escuela: escuelas del barrio estudiantil. Universidad: corazón de la Sorbonne. Bus: buses RATP. Metro: Cluny-La Sorbonne (L10), RER B Luxembourg. Comer: cafés históricos y bistrós. Súper: supermercados y mercados.',
    'Bastille (París) — Escuela: escuelas del centro. Universidad: conectado; coworkings. Bus: muchas líneas RATP. Metro: Bastille (L1/L5/L8). Comer: bares, restaurantes y Marché d\'Aligre. Súper: supermercados cerca.',
    'Jordaan (Ámsterdam) — Escuela: escuelas del barrio. Universidad: centro y coworkings. Bus: tranvías 13/17 y buses; mucha bici. Metro: a pie del centro; bien conectado. Comer: cafés "bruin" y Noordermarkt. Súper: supermercados de barrio.',
    'De Pijp (Ámsterdam) — Escuela: escuelas del barrio. Universidad: UvA; coworkings. Bus: tranvías y buses; bici. Metro: Metro 52 (De Pijp). Comer: Mercado Albert Cuyp, cafés y restaurantes del mundo. Súper: supermercados y Albert Cuyp.',
    'Oud-West (Ámsterdam) — Escuela: buenas escuelas. Universidad: UvA; coworkings en De Hallen. Bus: tranvías 1/17; junto al Vondelpark. Metro: tranvía y metro bien conectados. Comer: food hall De Hallen, cafés y restaurantes. Súper: supermercados cerca.',
    'Neubau (Viena) — Escuela: escuelas del centro. Universidad: MuseumsQuartier; coworkings. Bus: buses y tranvías. Metro: U-Bahn U3 (Neubaugasse). Comer: cafés de diseño, brunch y restaurantes. Súper: supermercados a pasos.',
    'Leopoldstadt (Viena) — Escuela: escuelas del barrio. Universidad: WU (Economía) y su campus. Bus: buses y tranvías. Metro: U1 y U2 (Praterstern). Comer: cafés y restaurantes junto al Prater. Súper: supermercados cerca.',
    'Mariahilf (Viena) — Escuela: escuelas del barrio. Universidad: conectado a campus; coworkings. Bus: buses y tranvías. Metro: U3 y U6 (Westbahnhof). Comer: cafés y restaurantes en Mariahilfer Straße. Súper: supermercados de la calle comercial.'
  ],
  listings: [
...
function buildSystemPrompt() {
  ...
  const amenidades = (c.zonasAmenidades || []).map((z) => '- ' + z).join('\n');
  ...
  return [
    ...
    '',
    'QUÉ HAY CERCA POR BARRIO / WHAT IS NEARBY BY NEIGHBORHOOD (escuela/colegio, universidad, parada de bus, metro/estación, dónde comer (restaurantes/cafés) y supermercado). Úsalo para "¿hay metro/escuela/universidad/supermercado cerca de [barrio]?", "¿dónde como?", "¿cómo llego en transporte?" y "¿qué hay cerca de [un match]?". Son referencias REALES pero GENERALES (NO inventes direcciones exactas ni negocios concretos). Responde cálido y en el idioma del usuario:\n' + amenidades,
    '',
    'REGLA DE AMENIDADES / AMENITIES RULE: Si preguntan por la zona alrededor de un MATCH concreto (por su título), resuelve su barrio y responde con lo que hay cerca; menciona también su precio mensual. Si preguntan "¿cuánto cuesta / precio de [barrio o ciudad]?", responde con los precios de las opciones APROBADAS en ese lugar. / If asked about the area around a specific match (by its title), resolve its neighborhood and answer what is nearby; also mention its monthly price. If asked "how much / price in [neighborhood or city]?", answer with the prices of the APPROVED options there.',
    '',
    'SOLO APROBADOS / APPROVED ONLY: Recomienda, nombra o sugiere ÚNICAMENTE alojamientos del catálogo de abajo (todos están aprobados). Nunca inventes alojamientos ni menciones opciones fuera de este catálogo. Cuando nombres una opción, incluye SIEMPRE su precio mensual. / Recommend, name or suggest ONLY listings from the catalog below (all are approved). Never invent listings or mention options outside this catalog. Whenever you name an option, ALWAYS include its monthly price.',
    '',
    'CATÁLOGO DE ALOJAMIENTOS APROBADOS (única fuente real; precios mensuales, demostrativos):\n' + catalog,
    '',
    'FAQs:\n' + c.faqs.map((f) => '- ' + f).join('\n'),
    '',
